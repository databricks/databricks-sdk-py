...
.. py:class:: NetworkConnectivityAPI
    ...
    .. py:method:: create_network_connectivity_configuration(name, region)
    ...
    .. py:method:: create_private_endpoint_rule(network_connectivity_config_id, resource_id, group_id)
    ...
    .. py:method:: delete_network_connectivity_configuration(network_connectivity_config_id)
    ...
    .. py:method:: delete_private_endpoint_rule(network_connectivity_config_id, private_endpoint_rule_id)
    ...
    .. py:method:: get_network_connectivity_configuration(network_connectivity_config_id)
    ...
    .. py:method:: get_private_endpoint_rule(network_connectivity_config_id, private_endpoint_rule_id)
