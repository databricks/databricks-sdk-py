...
.. py:class:: PrivateAccessAPI
    ...
    .. py:method:: create(private_access_settings_name, region [, allowed_vpc_endpoint_ids, private_access_level, public_access_enabled])
    ...
    .. py:method:: delete(private_access_settings_id)
    ...
    .. py:method:: get(private_access_settings_id)
