...
.. py:class:: AccountIamV2API
    ...
    .. py:method:: create_workspace_assignment(workspace_id: int, workspace_assignment: WorkspaceAssignment) -> WorkspaceAssignment
    ...
    .. py:method:: delete_workspace_assignment(workspace_id: int, principal_id: int)
    ...
    .. py:method:: get_workspace_assignment(workspace_id: int, principal_id: int) -> WorkspaceAssignment
    ...
    .. py:method:: update_workspace_assignment(workspace_id: int, principal_id: int, workspace_assignment: WorkspaceAssignment, update_mask: FieldMask) -> WorkspaceAssignment
