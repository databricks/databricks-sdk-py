...
.. py:class:: ModelRegistryAPI
    ...
    .. py:method:: approve_transition_request(name, version, stage, archive_existing_versions [, comment])
    ...
    .. py:method:: create_comment(name, version, comment)
    ...
    .. py:method:: create_model(name [, description, tags])
    ...
    .. py:method:: create_model_version(name, source [, description, run_id, run_link, tags])
    ...
    .. py:method:: create_transition_request(name, version, stage [, comment])
    ...
    .. py:method:: create_webhook(events [, description, http_url_spec, job_spec, model_name, status])
    ...
    .. py:method:: delete_model_tag(name, key)
    ...
    .. py:method:: delete_model_version(name, version)
    ...
    .. py:method:: delete_model_version_tag(name, version, key)
    ...
    .. py:method:: delete_transition_request(name, version, stage, creator [, comment])
    ...
    .. py:method:: get_latest_versions(name [, stages])
    ...
    .. py:method:: get_model_version(name, version)
    ...
    .. py:method:: get_model_version_download_uri(name, version)
    ...
    .. py:method:: list_transition_requests(name, version)
    ...
    .. py:method:: reject_transition_request(name, version, stage [, comment])
    ...
    .. py:method:: rename_model(name [, new_name])
    ...
    .. py:method:: search_model_versions( [, filter, max_results, order_by, page_token])
    ...
    .. py:method:: search_models( [, filter, max_results, order_by, page_token])
    ...
    .. py:method:: set_model_tag(name, key, value)
    ...
    .. py:method:: set_model_version_tag(name, version, key, value)
    ...
    .. py:method:: transition_stage(name, version, stage, archive_existing_versions [, comment])
    ...
    .. py:method:: update_comment(id, comment)
    ...
    .. py:method:: update_model(name [, description])
    ...
    .. py:method:: update_model_version(name, version [, description])
