...
.. py:class:: JobsExt
    ...
    .. py:method:: list( [, expand_tasks: bool, limit: int, name: str, offset: int, page_token: str]) -> BaseJob
    ...
    .. py:method:: list_runs( [, active_only: bool, completed_only: bool, expand_tasks: bool, job_id: int, limit: int, offset: int, page_token: str, run_type: RunType, start_time_from: int, start_time_to: int]) -> BaseRun
