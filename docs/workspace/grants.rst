...
.. py:class:: GrantsAPI
    ...
    .. py:method:: get(securable_type, full_name [, principal])
    ...
    .. py:method:: get_effective(securable_type, full_name [, principal])
    ...
    .. py:method:: update(securable_type, full_name [, changes])
