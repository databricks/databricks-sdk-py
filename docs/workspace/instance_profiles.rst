...
.. py:class:: InstanceProfilesAPI
    ...
    .. py:method:: add(instance_profile_arn [, iam_role_arn, is_meta_instance_profile, skip_validation])
    ...
    .. py:method:: edit(instance_profile_arn [, iam_role_arn, is_meta_instance_profile])
    ...
    .. py:method:: remove(instance_profile_arn)
