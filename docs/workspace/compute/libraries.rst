...
.. py:class:: LibrariesAPI
    ...
    .. py:method:: create_default_base_environment(default_base_environment: DefaultBaseEnvironment [, request_id: Optional[str], workspace_base_environment_id: Optional[str]]) -> DefaultBaseEnvironment
