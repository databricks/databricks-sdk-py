...
.. py:class:: WorkspaceIamV2API
    ...
    .. py:method:: create_group_membership_proxy(group_id: int, group_membership: GroupMembership) -> GroupMembership
    ...
    .. py:method:: delete_group_membership_proxy(group_id: int, principal_id: int)
