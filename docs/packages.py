...
MANUAL_PACKAGES = [
    Package(
        "workspace", "Workspace", "Manage workspace-level entities that include notebooks, Git checkouts, and secrets"
    ),
    ...
    Package("ml", "Machine Learning", "Create and manage experiments, features, and other machine learning artifacts"),
    ...
    Package(
        "sharing", "Delta Sharing", "Configure data sharing with Unity Catalog for providers, recipients, and shares"
    ),
    ...
    Package(
        "marketplace",
        "Marketplace",
        "Manage AI and analytics assets such as ML models, notebooks, applications in an open marketplace",
    ),
    ...
    Package("qualitymonitorv2", "Quality Monitor", "Manage quality monitor on Unity Catalog objects."),
    Package(
        "database",
        "Database Instances",
        "Create Database Instances and manage their configurations, including integrations with Unity Catalog",
    ),
    Package("agentbricks", "Agent Bricks", "Create and manage Agent Bricks resources."),
    Package("iamv2", "Identity and Access Management", "Manage identities and workspace access."),
    Package("dataquality", "Data Quality", "Manage data quality monitoring on Unity Catalog objects."),
    Package("postgres", "Postgres", "provides access to a Postgres database via REST API or direct SQL."),
    Package("networking", "Networking", "Manage network connectivity configurations for Databricks workspaces."),
    Package(
        "knowledgeassistants",
...
AUTO_PACKAGES = [
    ...
    Package("dashboards", "", ""),
    Package(
        "database", "Database Instances", "Database Instances provide access to a database via REST API or direct SQL."
    ),
    Package(
        "dataclassification",
        "Data Classification",
...
if _undocumented:
    raise RuntimeError(
        ...
        "would land in permanent rendered identifiers: " + ", ".join(sorted(_undocumented))
    )
