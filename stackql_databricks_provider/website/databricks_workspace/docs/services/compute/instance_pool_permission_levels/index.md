...
<tr>
    ...
    <td></td>
    <td>Gets the permission levels that a user can have on an object.<br /><br />:param instance_pool_id: str<br />  The instance pool for which to get or manage permissions.<br /><br />:returns: :class:`GetInstancePoolPermissionLevelsResponse`</td>
</tr>
</tbody>
</table>
...
Gets the permission levels that a user can have on an object.<br /><br />:param instance_pool_id: str<br />  The instance pool for which to get or manage permissions.<br /><br />:returns: :class:`GetInstancePoolPermissionLevelsResponse`
