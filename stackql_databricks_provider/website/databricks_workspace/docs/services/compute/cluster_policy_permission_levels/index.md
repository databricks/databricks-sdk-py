...
<tr>
    ...
    <td></td>
    <td>Gets the permission levels that a user can have on an object.<br /><br />:param cluster_policy_id: str<br />  The cluster policy for which to get or manage permissions.<br /><br />:returns: :class:`GetClusterPolicyPermissionLevelsResponse`</td>
</tr>
</tbody>
</table>
...
Gets the permission levels that a user can have on an object.<br /><br />:param cluster_policy_id: str<br />  The cluster policy for which to get or manage permissions.<br /><br />:returns: :class:`GetClusterPolicyPermissionLevelsResponse`
