  ...
  props:
    ...
    - name: schedule
      ...
      - name: timezone_id
        value: string
        description: |
          A Java timezone ID. The schedule for a job is resolved with respect to this timezone. See [Java TimeZone] for details. This field is required. [Java TimeZone]: https://docs.oracle.com/javase/7/docs/api/java/util/TimeZone.html
      - name: pause_status
        value: string
        description: |
