...
from .provisioning import (CredentialsAPI, EncryptionKeysAPI, NetworksAPI,
                           PrivateAccessAPI, StorageAPI, VpcEndpointsAPI,
                           WorkspacesAPI)
...
class EncryptionKeysClient(EncryptionKeysAPI):
    """
    ...
    * Managed services: A key configuration can be used to encrypt a workspace's notebook and secret
    data in the control plane, as well as Databricks SQL queries and query history. * Storage: A key
    configuration can be used to encrypt a workspace's DBFS and EBS data in the data plane.
    ...
    version of the platform. If you have an older workspace, it might not be on the E2 version of
    the platform. If you are not sure, contact your Databricks representative.
    """
...
class NetworksClient(NetworksAPI):
    """
...
class PrivateAccessClient(PrivateAccessAPI):
    """
...
class StorageClient(StorageAPI):
    """
...
class VpcEndpointsClient(VpcEndpointsAPI):
    """
...
class WorkspacesClient(WorkspacesAPI):
    """
