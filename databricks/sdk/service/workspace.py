...
class DirectoryInfo:
    ...
    """Whether this directory is a Git folder: a Git-backed folder whose contents are
    version-controlled and that supports Git operations."""
...
class ObjectInfo:
    ...
    """Directory-specific metadata. Set only when ``object_type`` is ``DIRECTORY``."""
