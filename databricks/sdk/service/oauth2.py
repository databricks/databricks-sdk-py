...
class CreateCustomAppIntegrationOutput:
    ...
    client_secret_expire_time: Optional[Timestamp] = None
    """The expiration time of the client secret. If not present, the secret does not expire."""
    ...
    def as_dict(self) -> dict:
        ...
        if self.client_secret_expire_time is not None:
            body["client_secret_expire_time"] = self.client_secret_expire_time.ToJsonString()
    ...
    def as_shallow_dict(self) -> dict:
        ...
        if self.client_secret is not None:
            body["client_secret"] = self.client_secret
        if self.client_secret_expire_time is not None:
            body["client_secret_expire_time"] = self.client_secret_expire_time
        if self.integration_id is not None:
            body["integration_id"] = self.integration_id
        if self.principal_id is not None:
            body["principal_id"] = self.principal_id
...
class CreateServicePrincipalSecretResponse:
    ...
    """OAuth API scopes bound to this secret. Empty = unrestricted (all-apis)."""
...
class PublishedAppIntegrationAPI:
    ...
    def list(
        self, *, page_size: Optional[int] = None, page_token: Optional[str] = None, search_keyword: Optional[str] = None
...
class ServicePrincipalSecretsAPI:
    ...
    def create(
        self, service_principal_id: str, *, lifetime: Optional[str] = None, scopes: Optional[List[str]] = None
