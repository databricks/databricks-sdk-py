...
class EndpointsAPI:
    ...
    def delete_endpoint(self, name: str):
        """Deletes a network endpoint. This will remove the endpoint configuration from <Databricks>. Depending
        on the endpoint type and use case, you may also need to delete corresponding network resources in your
