...
@dataclass
class DeleteDatabaseInstanceRoleResponse:
    def as_dict(self) -> dict:
        """Serializes the DeleteDatabaseInstanceRoleResponse into a dictionary suitable for use as a JSON request body."""
        body = {}
        return body

    def as_shallow_dict(self) -> dict:
        """Serializes the DeleteDatabaseInstanceRoleResponse into a shallow dictionary of its immediate attributes."""
        body = {}
        return body

    @classmethod
    def from_dict(cls, d: Dict[str, Any]) -> DeleteDatabaseInstanceRoleResponse:
        """Deserializes the DeleteDatabaseInstanceRoleResponse from a dictionary."""
        return cls()
...
@dataclass
class FailoverDatabaseInstanceRequest:
    failover_target_database_instance_name: Optional[str] = None

    name: Optional[str] = None
    """Name of the instance to failover."""

    def as_dict(self) -> dict:
        """Serializes the FailoverDatabaseInstanceRequest into a dictionary suitable for use as a JSON request body."""
        body = {}
        if self.failover_target_database_instance_name is not None:
            body["failover_target_database_instance_name"] = self.failover_target_database_instance_name
        if self.name is not None:
            body["name"] = self.name
        return body

    def as_shallow_dict(self) -> dict:
        """Serializes the FailoverDatabaseInstanceRequest into a shallow dictionary of its immediate attributes."""
        body = {}
        if self.failover_target_database_instance_name is not None:
            body["failover_target_database_instance_name"] = self.failover_target_database_instance_name
        if self.name is not None:
    ...
    @classmethod
    def from_dict(cls, d: Dict[str, Any]) -> FailoverDatabaseInstanceRequest:
        """Deserializes the FailoverDatabaseInstanceRequest from a dictionary."""
        return cls(
            failover_target_database_instance_name=d.get("failover_target_database_instance_name", None),
            name=d.get("name", None),
        )
