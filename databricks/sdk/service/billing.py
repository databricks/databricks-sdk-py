...
class LogDeliveryAPI:
    ...
    1. **Create storage**: In AWS, `create a new AWS S3 bucket
       ...
       bucket policy. Using Databricks APIs, call the Account API to create a [storage configuration
    ...
    3. **Create log delivery configuration**: Using Databricks APIs, call the Account API to [create a log
       ...
       your account (*Account level* delivery) or only events for a specific set of workspaces (*workspace
       level* delivery). Account level log delivery applies to all current and future workspaces plus account
       level logs, while workspace level log delivery solely delivers logs related to the specified
