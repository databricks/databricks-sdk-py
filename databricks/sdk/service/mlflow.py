...
class Activity:
    ...
    def as_request(self) -> (dict, dict):
        activity_query, activity_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'Activity':
        return cls(
            activity_type=ActivityType(d['activity_type']) if 'activity_type' in d else None,
...
class ApproveTransitionRequest:
    ...
    def as_request(self) -> (dict, dict):
        approveTransitionRequest_query, approveTransitionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.archive_existing_versions:
            approveTransitionRequest_body['archive_existing_versions'] = self.archive_existing_versions
        if self.comment:
...
class CommentObject:
    ...
    def as_request(self) -> (dict, dict):
        commentObject_query, commentObject_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.available_actions:
            commentObject_body['available_actions'] = [v for v in self.available_actions]
        if self.comment:
...
class CreateComment:
    ...
    def as_request(self) -> (dict, dict):
        createComment_query, createComment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.comment:
...
class CreateExperiment:
    ...
    def as_request(self) -> (dict, dict):
        createExperiment_query, createExperiment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class CreateExperimentResponse:
    ...
    def as_request(self) -> (dict, dict):
        createExperimentResponse_query, createExperimentResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class CreateModelVersionRequest:
    ...
    def as_request(self) -> (dict, dict):
        createModelVersionRequest_query, createModelVersionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
        ...
        if self.tags:
            createModelVersionRequest_body['tags'] = [v.as_request()[1] for v in self.tags]
...
class CreateModelVersionResponse:
    ...
    def as_request(self) -> (dict, dict):
        createModelVersionResponse_query, createModelVersionResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_version:
            createModelVersionResponse_body['model_version'] = self.model_version.as_request()[1]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'CreateModelVersionResponse':
        return cls(
            model_version=ModelVersion.from_dict(d['model_version']) if 'model_version' in d else None,
        )
...
class CreateRegisteredModelRequest:
    ...
    def as_request(self) -> (dict, dict):
        createRegisteredModelRequest_query, createRegisteredModelRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
            createRegisteredModelRequest_body['description'] = self.description
        if self.name:
            createRegisteredModelRequest_body['name'] = self.name
        if self.tags:
            createRegisteredModelRequest_body['tags'] = [v.as_request()[1] for v in self.tags]
...
class CreateRegisteredModelResponse:
    ...
    def as_request(self) -> (dict, dict):
        createRegisteredModelResponse_query, createRegisteredModelResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.registered_model:
            createRegisteredModelResponse_body['registered_model'] = self.registered_model.as_request()[1]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'CreateRegisteredModelResponse':
        return cls(
            registered_model=RegisteredModel.from_dict(d['registered_model']) if 'registered_model' in d else None,
        )
...
class CreateRegistryWebhook:
    ...
    def as_request(self) -> (dict, dict):
        createRegistryWebhook_query, createRegistryWebhook_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
        ...
        if self.http_url_spec:
            createRegistryWebhook_body['http_url_spec'] = self.http_url_spec.as_request()[1]
        if self.job_spec:
...
class CreateRun:
    ...
    def as_request(self) -> (dict, dict):
        createRun_query, createRun_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class CreateRunResponse:
    ...
    def as_request(self) -> (dict, dict):
        createRunResponse_query, createRunResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.run:
...
class CreateTransitionRequest:
    ...
    def as_request(self) -> (dict, dict):
        createTransitionRequest_query, createTransitionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.comment:
...
class DeleteExperiment:
    ...
    def as_request(self) -> (dict, dict):
        deleteExperiment_query, deleteExperiment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class DeleteModelVersionRequest:
    ...
    def as_request(self) -> (dict, dict):
        deleteModelVersionRequest_query, deleteModelVersionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class DeleteModelVersionTagRequest:
    ...
    def as_request(self) -> (dict, dict):
        deleteModelVersionTagRequest_query, deleteModelVersionTagRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class DeleteRegisteredModelRequest:
    ...
    def as_request(self) -> (dict, dict):
        deleteRegisteredModelRequest_query, deleteRegisteredModelRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class DeleteRegisteredModelTagRequest:
    ...
    def as_request(self) -> (dict, dict):
        deleteRegisteredModelTagRequest_query, deleteRegisteredModelTagRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
            deleteRegisteredModelTagRequest_query['key'] = self.key
        if self.name:
            deleteRegisteredModelTagRequest_query['name'] = self.name
        
        return deleteRegisteredModelTagRequest_query, deleteRegisteredModelTagRequest_body
...
class DeleteTag:
    ...
    def as_request(self) -> (dict, dict):
        deleteTag_query, deleteTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class Experiment:
    ...
    def as_request(self) -> (dict, dict):
        experiment_query, experiment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.artifact_location:
...
class ExperimentTag:
    ...
    def as_request(self) -> (dict, dict):
        experimentTag_query, experimentTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class GetExperimentByNameResponse:
    ...
    def as_request(self) -> (dict, dict):
        getExperimentByNameResponse_query, getExperimentByNameResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment:
            getExperimentByNameResponse_body['experiment'] = self.experiment.as_request()[1]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'GetExperimentByNameResponse':
        return cls(
            experiment=Experiment.from_dict(d['experiment']) if 'experiment' in d else None,
        )
...
class GetLatestVersionsRequest:
    ...
    def as_request(self) -> (dict, dict):
        getLatestVersionsRequest_query, getLatestVersionsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class GetLatestVersionsResponse:
    ...
    def as_request(self) -> (dict, dict):
        getLatestVersionsResponse_query, getLatestVersionsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_versions:
            getLatestVersionsResponse_body['model_versions'] = [v.as_request()[1] for v in self.model_versions]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'GetLatestVersionsResponse':
        return cls(
            model_versions=[ModelVersion.from_dict(v) for v in d['model_versions']] if 'model_versions' in d else None,
        )
...
class GetMetricHistoryResponse:
    ...
    def as_request(self) -> (dict, dict):
        getMetricHistoryResponse_query, getMetricHistoryResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.metrics:
            getMetricHistoryResponse_body['metrics'] = [v.as_request()[1] for v in self.metrics]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'GetMetricHistoryResponse':
        return cls(
            metrics=[Metric.from_dict(v) for v in d['metrics']] if 'metrics' in d else None,
        )
...
class GetModelVersionDownloadUriRequest:
    ...
    def as_request(self) -> (dict, dict):
        getModelVersionDownloadUriRequest_query, getModelVersionDownloadUriRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
            getModelVersionDownloadUriRequest_query['name'] = self.name
        if self.version:
            getModelVersionDownloadUriRequest_query['version'] = self.version
        
        return getModelVersionDownloadUriRequest_query, getModelVersionDownloadUriRequest_body
...
class GetModelVersionDownloadUriResponse:
    ...
    def as_request(self) -> (dict, dict):
        getModelVersionDownloadUriResponse_query, getModelVersionDownloadUriResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.artifact_uri:
            getModelVersionDownloadUriResponse_body['artifact_uri'] = self.artifact_uri
        
        return getModelVersionDownloadUriResponse_query, getModelVersionDownloadUriResponse_body
...
class GetModelVersionRequest:
    ...
    def as_request(self) -> (dict, dict):
        getModelVersionRequest_query, getModelVersionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class GetModelVersionResponse:
    ...
    def as_request(self) -> (dict, dict):
        getModelVersionResponse_query, getModelVersionResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_version:
            getModelVersionResponse_body['model_version'] = self.model_version.as_request()[1]
...
class GetRegisteredModelRequest:
    ...
    def as_request(self) -> (dict, dict):
        getRegisteredModelRequest_query, getRegisteredModelRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class GetRegisteredModelResponse:
    ...
    def as_request(self) -> (dict, dict):
        getRegisteredModelResponse_query, getRegisteredModelResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.registered_model:
            getRegisteredModelResponse_body['registered_model'] = self.registered_model.as_request()[1]
...
class GetRunResponse:
    ...
    def as_request(self) -> (dict, dict):
        getRunResponse_query, getRunResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.run:
...
class HttpUrlSpec:
    ...
    def as_request(self) -> (dict, dict):
        httpUrlSpec_query, httpUrlSpec_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class HttpUrlSpecWithoutSecret:
    ...
    def as_request(self) -> (dict, dict):
        httpUrlSpecWithoutSecret_query, httpUrlSpecWithoutSecret_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.enable_ssl_verification:
            httpUrlSpecWithoutSecret_body['enable_ssl_verification'] = self.enable_ssl_verification
        if self.url:
...
class JobSpec:
    ...
    def as_request(self) -> (dict, dict):
        jobSpec_query, jobSpec_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class JobSpecWithoutSecret:
    ...
    def as_request(self) -> (dict, dict):
        jobSpecWithoutSecret_query, jobSpecWithoutSecret_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.job_id:
...
class ListArtifactsResponse:
    ...
    def as_request(self) -> (dict, dict):
        listArtifactsResponse_query, listArtifactsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.files:
            listArtifactsResponse_body['files'] = [v.as_request()[1] for v in self.files]
...
class ListExperimentsResponse:
    ...
    def as_request(self) -> (dict, dict):
        listExperimentsResponse_query, listExperimentsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiments:
            listExperimentsResponse_body['experiments'] = [v.as_request()[1] for v in self.experiments]
        if self.next_page_token:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'ListExperimentsResponse':
        return cls(
            experiments=[Experiment.from_dict(v) for v in d['experiments']] if 'experiments' in d else None,
            next_page_token=d.get('next_page_token', None),
        )
...
class ListRegisteredModelsRequest:
    ...
    def as_request(self) -> (dict, dict):
        listRegisteredModelsRequest_query, listRegisteredModelsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.max_results:
...
class ListRegisteredModelsResponse:
    ...
    def as_request(self) -> (dict, dict):
        listRegisteredModelsResponse_query, listRegisteredModelsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.next_page_token:
            listRegisteredModelsResponse_body['next_page_token'] = self.next_page_token
        if self.registered_models:
            listRegisteredModelsResponse_body['registered_models'] = [v.as_request()[1] for v in self.registered_models]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'ListRegisteredModelsResponse':
        return cls(
            next_page_token=d.get('next_page_token', None),
            registered_models=[RegisteredModel.from_dict(v) for v in d['registered_models']] if 'registered_models' in d else None,
        )
...
class ListRegistryWebhooks:
    ...
    def as_request(self) -> (dict, dict):
        listRegistryWebhooks_query, listRegistryWebhooks_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.next_page_token:
            listRegistryWebhooks_body['next_page_token'] = self.next_page_token
        if self.webhooks:
            listRegistryWebhooks_body['webhooks'] = [v.as_request()[1] for v in self.webhooks]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'ListRegistryWebhooks':
        return cls(
            next_page_token=d.get('next_page_token', None),
            webhooks=[RegistryWebhook.from_dict(v) for v in d['webhooks']] if 'webhooks' in d else None,
        )
...
class LogBatch:
    ...
    def as_request(self) -> (dict, dict):
        logBatch_query, logBatch_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.metrics:
...
class LogMetric:
    ...
    def as_request(self) -> (dict, dict):
        logMetric_query, logMetric_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class LogModel:
    ...
    def as_request(self) -> (dict, dict):
        logModel_query, logModel_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_json:
...
class LogParam:
    ...
    def as_request(self) -> (dict, dict):
        logParam_query, logParam_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class Metric:
    ...
    def as_request(self) -> (dict, dict):
        metric_query, metric_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class ModelVersion:
    ...
    def as_request(self) -> (dict, dict):
        modelVersion_query, modelVersion_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.creation_timestamp:
...
class ModelVersionDatabricks:
    ...
    def as_request(self) -> (dict, dict):
        modelVersionDatabricks_query, modelVersionDatabricks_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.creation_timestamp:
        ...
        if self.last_updated_timestamp:
            modelVersionDatabricks_body['last_updated_timestamp'] = self.last_updated_timestamp
        if self.name:
            modelVersionDatabricks_body['name'] = self.name
        if self.permission_level:
            modelVersionDatabricks_body['permission_level'] = self.permission_level.value
        if self.run_id:
...
class ModelVersionTag:
    ...
    def as_request(self) -> (dict, dict):
        modelVersionTag_query, modelVersionTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class Param:
    ...
    def as_request(self) -> (dict, dict):
        param_query, param_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class RegisteredModel:
    ...
    def as_request(self) -> (dict, dict):
        registeredModel_query, registeredModel_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.creation_timestamp:
        ...
        if self.latest_versions:
            registeredModel_body['latest_versions'] = [v.as_request()[1] for v in self.latest_versions]
        if self.name:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'RegisteredModel':
        return cls(
            ...
            description=d.get('description', None),
            last_updated_timestamp=d.get('last_updated_timestamp', None),
            latest_versions=[ModelVersion.from_dict(v) for v in d['latest_versions']] if 'latest_versions' in d else None,
            name=d.get('name', None),
            tags=[RegisteredModelTag.from_dict(v) for v in d['tags']] if 'tags' in d else None,
            user_id=d.get('user_id', None),
        )
...
class RegisteredModelDatabricks:
    ...
    def as_request(self) -> (dict, dict):
        registeredModelDatabricks_query, registeredModelDatabricks_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.creation_timestamp:
            registeredModelDatabricks_body['creation_timestamp'] = self.creation_timestamp
        if self.description:
            registeredModelDatabricks_body['description'] = self.description
        if self.id:
            registeredModelDatabricks_body['id'] = self.id
        if self.last_updated_timestamp:
            registeredModelDatabricks_body['last_updated_timestamp'] = self.last_updated_timestamp
        if self.latest_versions:
            registeredModelDatabricks_body['latest_versions'] = [v.as_request()[1] for v in self.latest_versions]
        if self.name:
            registeredModelDatabricks_body['name'] = self.name
        if self.permission_level:
            registeredModelDatabricks_body['permission_level'] = self.permission_level.value
        if self.tags:
            registeredModelDatabricks_body['tags'] = [v.as_request()[1] for v in self.tags]
        if self.user_id:
...
class RegisteredModelTag:
    ...
    def as_request(self) -> (dict, dict):
        registeredModelTag_query, registeredModelTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class RegistryWebhook:
    ...
    def as_request(self) -> (dict, dict):
        registryWebhook_query, registryWebhook_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.creation_timestamp:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'RegistryWebhook':
        return cls(
            ...
            description=d.get('description', None),
            events=d.get('events', None),
            http_url_spec=HttpUrlSpecWithoutSecret.from_dict(d['http_url_spec']) if 'http_url_spec' in d else None,
            id=d.get('id', None),
...
class RejectTransitionRequest:
    ...
    def as_request(self) -> (dict, dict):
        rejectTransitionRequest_query, rejectTransitionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.comment:
...
class RenameRegisteredModelRequest:
    ...
    def as_request(self) -> (dict, dict):
        renameRegisteredModelRequest_query, renameRegisteredModelRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.name:
...
class RenameRegisteredModelResponse:
    ...
    def as_request(self) -> (dict, dict):
        renameRegisteredModelResponse_query, renameRegisteredModelResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.registered_model:
            renameRegisteredModelResponse_body['registered_model'] = self.registered_model.as_request()[1]
...
class RestoreExperiment:
    ...
    def as_request(self) -> (dict, dict):
        restoreExperiment_query, restoreExperiment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class RestoreRun:
    ...
    def as_request(self) -> (dict, dict):
        restoreRun_query, restoreRun_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.run_id:
...
class RunData:
    ...
    def as_request(self) -> (dict, dict):
        runData_query, runData_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.metrics:
...
class RunInfo:
    ...
    def as_request(self) -> (dict, dict):
        runInfo_query, runInfo_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.artifact_uri:
...
class RunTag:
    ...
    def as_request(self) -> (dict, dict):
        runTag_query, runTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class SearchExperiments:
    ...
    def as_request(self) -> (dict, dict):
        searchExperiments_query, searchExperiments_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.filter:
...
class SearchExperimentsResponse:
    ...
    def as_request(self) -> (dict, dict):
        searchExperimentsResponse_query, searchExperimentsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiments:
            searchExperimentsResponse_body['experiments'] = [v.as_request()[1] for v in self.experiments]
        if self.next_page_token:
...
class SearchModelVersionsRequest:
    ...
    def as_request(self) -> (dict, dict):
        searchModelVersionsRequest_query, searchModelVersionsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.filter:
...
class SearchModelVersionsResponse:
    ...
    def as_request(self) -> (dict, dict):
        searchModelVersionsResponse_query, searchModelVersionsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_versions:
            searchModelVersionsResponse_body['model_versions'] = [v.as_request()[1] for v in self.model_versions]
        if self.next_page_token:
...
class SearchRegisteredModelsRequest:
    ...
    def as_request(self) -> (dict, dict):
        searchRegisteredModelsRequest_query, searchRegisteredModelsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.filter:
...
class SearchRegisteredModelsResponse:
    ...
    def as_request(self) -> (dict, dict):
        searchRegisteredModelsResponse_query, searchRegisteredModelsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.next_page_token:
            searchRegisteredModelsResponse_body['next_page_token'] = self.next_page_token
        if self.registered_models:
            searchRegisteredModelsResponse_body['registered_models'] = [v.as_request()[1] for v in self.registered_models]
...
class SearchRuns:
    ...
    def as_request(self) -> (dict, dict):
        searchRuns_query, searchRuns_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class SearchRunsResponse:
    ...
    def as_request(self) -> (dict, dict):
        searchRunsResponse_query, searchRunsResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.next_page_token:
...
class SetExperimentTag:
    ...
    def as_request(self) -> (dict, dict):
        setExperimentTag_query, setExperimentTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class SetModelVersionTagRequest:
    ...
    def as_request(self) -> (dict, dict):
        setModelVersionTagRequest_query, setModelVersionTagRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class SetRegisteredModelTagRequest:
    ...
    def as_request(self) -> (dict, dict):
        setRegisteredModelTagRequest_query, setRegisteredModelTagRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class SetTag:
    ...
    def as_request(self) -> (dict, dict):
        setTag_query, setTag_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.key:
...
class TestRegistryWebhook:
    ...
    def as_request(self) -> (dict, dict):
        testRegistryWebhook_query, testRegistryWebhook_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.body:
...
class TestRegistryWebhookRequest:
    ...
    def as_request(self) -> (dict, dict):
        testRegistryWebhookRequest_query, testRegistryWebhookRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.event:
...
class TransitionModelVersionStage:
    ...
    def as_request(self) -> (dict, dict):
        transitionModelVersionStage_query, transitionModelVersionStage_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.archive_existing_versions:
            transitionModelVersionStage_body['archive_existing_versions'] = self.archive_existing_versions
        if self.name:
...
class TransitionModelVersionStageDatabricks:
    ...
    def as_request(self) -> (dict, dict):
        transitionModelVersionStageDatabricks_query, transitionModelVersionStageDatabricks_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.archive_existing_versions:
            transitionModelVersionStageDatabricks_body['archive_existing_versions'] = self.archive_existing_versions
        if self.comment:
        ...
        return transitionModelVersionStageDatabricks_query, transitionModelVersionStageDatabricks_body
...
class TransitionModelVersionStageResponse:
    ...
    def as_request(self) -> (dict, dict):
        transitionModelVersionStageResponse_query, transitionModelVersionStageResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_version:
            transitionModelVersionStageResponse_body['model_version'] = self.model_version.as_request()[1]
        
        return transitionModelVersionStageResponse_query, transitionModelVersionStageResponse_body
...
class TransitionRequest:
    ...
    def as_request(self) -> (dict, dict):
        transitionRequest_query, transitionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.available_actions:
            transitionRequest_body['available_actions'] = [v for v in self.available_actions]
        if self.comment:
...
class UpdateComment:
    ...
    def as_request(self) -> (dict, dict):
        updateComment_query, updateComment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.comment:
...
class UpdateExperiment:
    ...
    def as_request(self) -> (dict, dict):
        updateExperiment_query, updateExperiment_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class UpdateModelVersionRequest:
    ...
    def as_request(self) -> (dict, dict):
        updateModelVersionRequest_query, updateModelVersionRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
...
class UpdateRegisteredModelRequest:
    ...
    def as_request(self) -> (dict, dict):
        updateRegisteredModelRequest_query, updateRegisteredModelRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
...
class UpdateRegistryWebhook:
    ...
    def as_request(self) -> (dict, dict):
        updateRegistryWebhook_query, updateRegistryWebhook_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.description:
            updateRegistryWebhook_body['description'] = self.description
        if self.events:
            updateRegistryWebhook_body['events'] = [v for v in self.events]
        if self.http_url_spec:
            updateRegistryWebhook_body['http_url_spec'] = self.http_url_spec.as_request()[1]
        if self.id:
...
class UpdateRun:
    ...
    def as_request(self) -> (dict, dict):
        updateRun_query, updateRun_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.end_time:
...
class UpdateRunResponse:
    ...
    def as_request(self) -> (dict, dict):
        updateRunResponse_query, updateRunResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.run_info:
...
class ApproveResponse:
    ...
    def as_request(self) -> (dict, dict):
        approveResponse_query, approveResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.activity:
...
class DeleteRequest:
    ...
    def as_request(self) -> (dict, dict):
        ...
        if self.id:
            deleteRequest_query['id'] = self.id
...
class GetByNameRequest:
    ...
    def as_request(self) -> (dict, dict):
        getByNameRequest_query, getByNameRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
...
class GetExperimentRequest:
    ...
    def as_request(self) -> (dict, dict):
        getExperimentRequest_query, getExperimentRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.experiment_id:
...
class GetHistoryRequest:
    ...
    run_uuid: str = None # query

    def as_request(self) -> (dict, dict):
        getHistoryRequest_query, getHistoryRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.metric_key:
...
class GetRequest:
    ...
    def as_request(self) -> (dict, dict):
        ...
        if self.name:
            getRequest_query['name'] = self.name
...
class GetResponse:
    ...
    def as_request(self) -> (dict, dict):
        getResponse_query, getResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.registered_model:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'GetResponse':
        return cls(
            registered_model=RegisteredModelDatabricks.from_dict(d['registered_model']) if 'registered_model' in d else None,
        )
...
class ListArtifactsRequest:
    ...
    def as_request(self) -> (dict, dict):
        listArtifactsRequest_query, listArtifactsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.page_token:
...
class ListExperimentsRequest:
    ...
    def as_request(self) -> (dict, dict):
        listExperimentsRequest_query, listExperimentsRequest_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.max_results:
...
class ListRequest:
    ...
    events: 'List[RegistryWebhookEvent]' = None # query
    ...
    def as_request(self) -> (dict, dict):
        ...
        if self.events:
            listRequest_query['events'] = [v for v in self.events]
        if self.model_name:
            listRequest_query['model_name'] = self.model_name
        if self.page_token:
            listRequest_query['page_token'] = self.page_token
...
class ListResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'ListResponse':
        return cls(
            requests=[Activity.from_dict(v) for v in d['requests']] if 'requests' in d else None,
        )
...
class RejectResponse:
    ...
    def as_request(self) -> (dict, dict):
        rejectResponse_query, rejectResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.activity:
...
class TestRegistryWebhookResponse:
    ...
    def as_request(self) -> (dict, dict):
        testRegistryWebhookResponse_query, testRegistryWebhookResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.webhook:
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'TestRegistryWebhookResponse':
        return cls(
            webhook=TestRegistryWebhook.from_dict(d['webhook']) if 'webhook' in d else None,
        )
...
class TransitionStageResponse:
    ...
    def as_request(self) -> (dict, dict):
        transitionStageResponse_query, transitionStageResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.model_version:
            transitionStageResponse_body['model_version'] = self.model_version.as_request()[1]
    ...
    def from_dict(cls, d: Dict[str, any]) -> 'TransitionStageResponse':
        return cls(
            model_version=ModelVersionDatabricks.from_dict(d['model_version']) if 'model_version' in d else None,
        )
...
class UpdateResponse:
    ...
    def as_request(self) -> (dict, dict):
        updateResponse_query, updateResponse_body = {}, {} # TODO: add .HasQuery() and .HasBody() to code generator
        if self.comment:
...
class ExperimentsAPI:
    ...
    def create(self, request: CreateExperiment) -> CreateExperimentResponse:
        ...
        json = self._api.do('POST', '/api/2.0/mlflow/experiments/create', query=query, body=body)
    ...
    def delete(self, request: DeleteExperiment):
        ...
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/experiments/delete', query=query, body=body)
    ...
    def get(self, request: GetExperimentRequest) -> Experiment:
        ...
        experiments."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/experiments/get', query=query, body=body)
        return Experiment.from_dict(json)
    
    def getByName(self, request: GetByNameRequest) -> GetExperimentByNameResponse:
        """Get metadata
        ...
        name exists.S"""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/experiments/get-by-name', query=query, body=body)
    ...
    def list(self, request: ListExperimentsRequest) -> ListExperimentsResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/experiments/list', query=query, body=body)
    ...
    def restore(self, request: RestoreExperiment):
        ...
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/experiments/restore', query=query, body=body)
    ...
    def search(self, request: SearchExperiments) -> SearchExperimentsResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/experiments/search', query=query, body=body)
        return SearchExperimentsResponse.from_dict(json)
    
    def setExperimentTag(self, request: SetExperimentTag):
        """Set a tag
        
        Sets a tag on an experiment. Experiment tags are metadata that can be
        updated."""
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/experiments/set-experiment-tag', query=query, body=body)
    ...
    def update(self, request: UpdateExperiment):
        ...
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/experiments/update', query=query, body=body)
...
class MLflowArtifactsAPI:
    ...
    def list(self, request: ListArtifactsRequest) -> ListArtifactsResponse:
        ...
        prefix.","""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/artifacts/list', query=query, body=body)
...
class MLflowDatabricksAPI:
    ...
    def get(self, request: GetRequest) -> GetResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/databricks/registered-models/get', query=query, body=body)
        return GetResponse.from_dict(json)
    
    def transitionStage(self, request: TransitionModelVersionStageDatabricks) -> TransitionStageResponse:
        """Transition a stage
        ...
        recorded.","""
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/databricks/model-versions/transition-stage', query=query, body=body)
...
class MLflowMetricsAPI:
    ...
    def getHistory(self, request: GetHistoryRequest) -> GetMetricHistoryResponse:
        """Get all history
        
        Gets a list of all values for the specified metric for a given run."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/metrics/get-history', query=query, body=body)
...
class MLflowRunsAPI:
    ...
    def create(self, request: CreateRun) -> CreateRunResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/runs/create', query=query, body=body)
    ...
    def deleteTag(self, request: DeleteTag):
        """Delete a tag
    ...
    def logBatch(self, request: LogBatch):
        """Log a batch
        ...
        ``` { "run_id": "2a14ed5c6a87499199e0106c3501eab8", "metrics": [ {
        "key": "mae", "value": 2.5, "timestamp": 1552550804 }, { "key": "rmse",
        "value": 2.7, "timestamp": 1552550804 }], "params": [ { \"key\":
        \"model_class\", \"value\": \"LogisticRegression\" }] } ```
    ...
    def logMetric(self, request: LogMetric):
        """Log a metric
    ...
    def logModel(self, request: LogModel):
        """Log a model
    ...
    def logParameter(self, request: LogParam):
        """Log a param
        ...
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/runs/log-parameter', query=query, body=body)
    ...
    def search(self, request: SearchRuns) -> SearchRunsResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/runs/search', query=query, body=body)
        return SearchRunsResponse.from_dict(json)
    
    def setTag(self, request: SetTag):
        """Set a tag
    ...
    def update(self, request: UpdateRun) -> UpdateRunResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/runs/update', query=query, body=body)
...
class ModelVersionCommentsAPI:
    ...
    def create(self, request: CreateComment) -> CreateResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/comments/create', query=query, body=body)
    ...
    def delete(self, request: DeleteRequest):
        ...
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/comments/delete', query=query, body=body)
    ...
    def update(self, request: UpdateComment) -> UpdateResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/comments/update', query=query, body=body)
...
class ModelVersionsAPI:
    ...
    def create(self, request: CreateModelVersionRequest) -> CreateModelVersionResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/model-versions/create', query=query, body=body)
    ...
    def delete(self, request: DeleteModelVersionRequest):
        ...
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/model-versions/delete', query=query, body=body)
        
    
    def deleteTag(self, request: DeleteModelVersionTagRequest):
        """Delete a model version tag
        
        Deletes a model version tag."""
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/model-versions/delete-tag', query=query, body=body)
    ...
    def get(self, request: GetModelVersionRequest) -> GetModelVersionResponse:
        ...
        Get a model version."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/model-versions/get', query=query, body=body)
        return GetModelVersionResponse.from_dict(json)
    
    def getDownloadUri(self, request: GetModelVersionDownloadUriRequest) -> GetModelVersionDownloadUriResponse:
        """Get a model version URI
        
        Gets a URI to download the model version."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/model-versions/get-download-uri', query=query, body=body)
        return GetModelVersionDownloadUriResponse.from_dict(json)
    
    def search(self, request: SearchModelVersionsRequest) -> SearchModelVersionsResponse:
        """Searches model versions
        
        Searches for specific model versions based on the supplied __filter__."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/model-versions/search', query=query, body=body)
        return SearchModelVersionsResponse.from_dict(json)
    
    def setTag(self, request: SetModelVersionTagRequest):
        """Set a version tag
        
        Sets a model version tag."""
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/model-versions/set-tag', query=query, body=body)
        
    
    def transitionStage(self, request: TransitionModelVersionStage) -> TransitionModelVersionStageResponse:
        """Transition a stage
        
        Transition to the next model stage."""
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/model-versions/transition-stage', query=query, body=body)
    ...
    def update(self, request: UpdateModelVersionRequest):
        ...
        query, body = request.as_request()
        self._api.do('PATCH', '/api/2.0/mlflow/model-versions/update', query=query, body=body)
...
class RegisteredModelsAPI:
    ...
    def create(self, request: CreateRegisteredModelRequest) -> CreateRegisteredModelResponse:
        """Create a model
        ...
        name exists."""
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/registered-models/create', query=query, body=body)
    ...
    def delete(self, request: DeleteRegisteredModelRequest):
        ...
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/registered-models/delete', query=query, body=body)
        
    
    def deleteTag(self, request: DeleteRegisteredModelTagRequest):
        """Delete a model tag
        
        Deletes the tag for a registered model."""
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/registered-models/delete-tag', query=query, body=body)
    ...
    def get(self, request: GetRegisteredModelRequest) -> GetRegisteredModelResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/registered-models/get', query=query, body=body)
        return GetRegisteredModelResponse.from_dict(json)
    
    def getLatestVersions(self, request: GetLatestVersionsRequest) -> GetLatestVersionsResponse:
        """Get the latest version
        
        Gets the latest version of a registered model."""
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/registered-models/get-latest-versions', query=query, body=body)
        return GetLatestVersionsResponse.from_dict(json)
    
    def list(self, request: ListRegisteredModelsRequest) -> ListRegisteredModelsResponse:
        """List models
        
        Lists all available registered models, up to the limit specified in
        __max_results__."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/registered-models/list', query=query, body=body)
        return ListRegisteredModelsResponse.from_dict(json)
    
    def rename(self, request: RenameRegisteredModelRequest) -> RenameRegisteredModelResponse:
        """Rename a model
        
        Renames a registered model."""
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/registered-models/rename', query=query, body=body)
        return RenameRegisteredModelResponse.from_dict(json)
    
    def search(self, request: SearchRegisteredModelsRequest) -> SearchRegisteredModelsResponse:
        """Search models
        
        Search for registered models based on the specified __filter__."""
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/registered-models/search', query=query, body=body)
        return SearchRegisteredModelsResponse.from_dict(json)
    
    def setTag(self, request: SetRegisteredModelTagRequest):
        """Set a tag
        
        Sets a tag on a registered model."""
        query, body = request.as_request()
        self._api.do('POST', '/api/2.0/mlflow/registered-models/set-tag', query=query, body=body)
    ...
    def update(self, request: UpdateRegisteredModelRequest):
        ...
        query, body = request.as_request()
        self._api.do('PATCH', '/api/2.0/mlflow/registered-models/update', query=query, body=body)
...
class RegistryWebhooksAPI:
    ...
    def create(self, request: CreateRegistryWebhook) -> CreateResponse:
        ...
        **NOTE**: This endpoint is in Public Preview.
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/registry-webhooks/create', query=query, body=body)
        return CreateResponse.from_dict(json)
    ...
    def delete(self, request: DeleteRequest):
        ...
        **NOTE:** This endpoint is in Public Preview.
        ...
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/registry-webhooks/delete', query=query, body=body)
        
    
    def list(self, request: ListRequest) -> ListRegistryWebhooks:
        ...
        **NOTE:** This endpoint is in Public Preview.
        ...
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/registry-webhooks/list', query=query, body=body)
    ...
    def test(self, request: TestRegistryWebhookRequest) -> TestRegistryWebhookResponse:
        ...
        **NOTE:** This endpoint is in Public Preview.
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/registry-webhooks/test', query=query, body=body)
    ...
    def update(self, request: UpdateRegistryWebhook):
        ...
        **NOTE:** This endpoint is in Public Preview.
        ...
        query, body = request.as_request()
        self._api.do('PATCH', '/api/2.0/mlflow/registry-webhooks/update', query=query, body=body)
...
class TransitionRequestsAPI:
    ...
    def approve(self, request: ApproveTransitionRequest) -> ApproveResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/transition-requests/approve', query=query, body=body)
    ...
    def create(self, request: CreateTransitionRequest) -> CreateResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/transition-requests/create', query=query, body=body)
        return CreateResponse.from_dict(json)
    ...
    def delete(self, request: DeleteRequest):
        ...
        query, body = request.as_request()
        self._api.do('DELETE', '/api/2.0/mlflow/transition-requests/delete', query=query, body=body)
    ...
    def list(self, request: ListRequest) -> ListResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('GET', '/api/2.0/mlflow/transition-requests/list', query=query, body=body)
    ...
    def reject(self, request: RejectTransitionRequest) -> RejectResponse:
        ...
        query, body = request.as_request()
        json = self._api.do('POST', '/api/2.0/mlflow/transition-requests/reject', query=query, body=body)
