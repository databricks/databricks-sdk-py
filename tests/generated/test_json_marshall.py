...
@pytest.mark.parametrize(
    "from_dict_method,instance,expected_dict",
    [
        (
        ...
        (
            ...
            {"optional_message": {"optional_string": "nested_value"}},
        ),
        (
            OptionalFields.from_dict,
            OptionalFields(
        ...
        (
            ...
            {"optional_string": "test", "optional_int32": 42, "optional_bool": True},
        ),
        (
            ...
            RequiredFields(
                ...
                required_field_mask=_fieldmask("*"),
                required_int32=0,
                required_int64=0,
                required_list_value=[],
        ...
        (
            ...
            {"repeated_message": [{"optional_string": "nested1"}, {"optional_string": "nested2"}]},
        ),
        (
            RepeatedFields.from_dict,
            RepeatedFields(
        ...
        (
            ...
            {"repeated_string": ["a", "b", "c"], "repeated_int32": [10, 20, 30], "repeated_bool": [True, False]},
        ),
        (
            RepeatedFields.from_dict,
            RepeatedFields(
        ...
        (
            ...
            {"optional_int32": 0, "optional_int64": 0, "optional_bool": False, "optional_string": ""},
        ),
        (
            OptionalFields.from_dict,
            OptionalFields(
...
def test_python_marshall(from_dict_method: any, instance: Any, expected_dict: Dict[str, Any]):
