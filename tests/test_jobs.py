...
def test_jobs_update(config, requests_mock):
    requests_mock.post(
        "http://localhost/api/2.1/jobs/update",
        request_headers={
            "Accept": "application/json",
            "Content-Type": "application/json",
        },
...
def test_jobs_list(config, requests_mock):
    requests_mock.get(
        "http://localhost/api/2.1/jobs/list",
        request_headers={
            "Accept": "application/json",
        },
        text="null",
...
def test_jobs_get(config, requests_mock):
    requests_mock.get(
        "http://localhost/api/2.1/jobs/get",
        request_headers={
            "Accept": "application/json",
        },
        text="null",
...
def test_jobs_reset(config, requests_mock):
    requests_mock.post(
        "http://localhost/api/2.1/jobs/reset",
        request_headers={
            "Accept": "application/json",
            "Content-Type": "application/json",
        },
...
def test_jobs_runs_list(config, requests_mock):
    requests_mock.get(
        "http://localhost/api/2.1/jobs/runs/list",
        request_headers={
            "Accept": "application/json",
        },
        text="null",
