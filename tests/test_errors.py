...
base_subclass_test_cases: list[(int, str, type)] = [
    ...
    (401, '', errors.Unauthenticated), (401, '', IOError), (403, '', errors.PermissionDenied),
    (403, '', IOError), (404, '', errors.NotFound), (404, '', IOError), (409, '', errors.ResourceConflict),
    (409, 'ABORTED', errors.Aborted), (409, 'ABORTED', errors.ResourceConflict),
    (409, 'ALREADY_EXISTS', errors.AlreadyExists), (409, 'ALREADY_EXISTS', errors.ResourceConflict),
    ...
    (429, 'RESOURCE_EXHAUSTED', errors.ResourceExhausted), (429, '', IOError), (499, '', errors.Cancelled),
    (499, '', IOError), (500, '', errors.InternalError), (500, 'UNKNOWN', errors.InternalError),
    (500, 'UNKNOWN', errors.Unknown), (500, 'DATA_LOSS', errors.InternalError),
    (500, 'DATA_LOSS', errors.DataLoss), (500, '', IOError), (501, '', errors.NotImplemented),
    (501, '', IOError), (503, '', errors.TemporarilyUnavailable), (503, '', IOError),
    (504, '', errors.DeadlineExceeded), (504, '', IOError), (444, '', errors.DatabricksError),
    (444, '', IOError),
]
